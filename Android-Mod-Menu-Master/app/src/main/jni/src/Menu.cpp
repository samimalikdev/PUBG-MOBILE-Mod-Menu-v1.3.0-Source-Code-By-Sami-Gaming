...
Java_uk_lgl_modmenu_FloatingModMenuService_Title(JNIEnv *env, jobject thiz) {
    titleValid = true;
    return env->NewStringUTF(OBFUSCATE("Modded by (Sami Gaming)"));
}
...
Java_uk_lgl_modmenu_FloatingModMenuService_ToastStartup(JNIEnv *env, jobject thiz) {
    MakeToast(env, thiz, OBFUSCATE("Menu loaded. Modded by Sami Gaming"), Toast::LENGTH_LONG);
}
...
Java_uk_lgl_modmenu_FloatingModMenuService_getFeatureList(JNIEnv *env, jobject activityObject) {
    ...
    const char *features[] = {
            ...
            OBFUSCATE("Toggle_BYPASS"),
            OBFUSCATE("Toggle_REMOVE LOGS + ANTI REPORT (KR)"),
            OBFUSCATE("Toggle_LESS RECOIL"),
            OBFUSCATE("Toggle_AIMBOT"),
            OBFUSCATE("Toggle_AIMLOCK"),
            OBFUSCATE("SeekBar_CAMERA VIEW_0_10"),
            OBFUSCATE("Toggle_ANTI SHAKE"),
            OBFUSCATE("Toggle_SMALL CROSSHAIR"),
            OBFUSCATE("Toggle_MAGIC BULLET"),
            OBFUSCATE("Toggle_AUTO HEADSHOT"),
            OBFUSCATE("Toggle_REMOVE FOG"),
            OBFUSCATE("Toggle_GET FOG"),
            OBFUSCATE("Toggle_BLUE FOG"),
            OBFUSCATE("Toggle_NIGHT MODE"),
            OBFUSCATE("Toggle_BLACK BODY"),
            OBFUSCATE("Toggle_INSTANT HIT"),
            OBFUSCATE("Toggle_SPEED HACK"),
            OBFUSCATE("Toggle_SPEED VEHICLES"),
            OBFUSCATE("Toggle_ANTENA"),
            OBFUSCATE("Toggle_WALL SHOOT"),
            OBFUSCATE("Toggle_LONG JUMP"),
            OBFUSCATE("Toggle_FLY CARS"),
            OBFUSCATE("Toggle_JUMP CARS"),
            OBFUSCATE("Toggle_HIGH DAMAGE"),
    };
